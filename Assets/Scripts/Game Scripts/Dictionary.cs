...
public class Dictionary : MonoBehaviour
{
    ...
    */
    ...
    {
        termsDefinitions.Add("STINFO stands for", "Scientific and Technical Information");
        termsDefinitions.Add("Unauthorized access to STINFO", "Damage to U.S. national security");
        termsDefinitions.Add("Categories of distribution", "Primary and secondary");
        termsDefinitions.Add("Distribution Statement A", "Approved for public release; distribution is unlimited");
    ...
    private void PlayCorrectMatchParticleEffect(Vector3 position)
    {
        ...
        ParticleSystem particleEffect = Instantiate(correctButtonPreFab, position, Quaternion.identity);
    ...
    */
    ...
    private void RestartGame() //Fixed the restart game method so it actually restarts the game -David
    {
    ...
    private void LoadNextScene()
    {
        ...
        SceneManager.LoadScene("DictionaryScene2");
    }
