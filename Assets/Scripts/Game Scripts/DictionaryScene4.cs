...
public class DictionaryScene4 : MonoBehaviour
{
    ...
    private void PrepareTermsAndDefinitions()
    {
        ...
        termsDefinitions.Add("Hard drive disposal", "Reformat and send to recycling center");
        termsDefinitions.Add("A CDO Liaison responsibility", "Report STINFO violations/deficiencies");
        termsDefinitions.Add("Type of IP right", "Unlimited rights");
        termsDefinitions.Add("How to protect STINFO documents via email", "Encryption");
