...
public class DictionaryScene5 : MonoBehaviour
{
    ...
    {
        termsDefinitions.Add("Type of IP right", "Restricted rights");
        termsDefinitions.Add("Proper method to dispose of flash drives", "Delete files and break device into pieces");
        termsDefinitions.Add("Data subject to export control IAW", "Export Administration Act");
        termsDefinitions.Add("Export Control Violation", "Imprisonment, fine, or both");
