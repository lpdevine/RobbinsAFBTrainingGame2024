...
public class DictionaryScene3 : MonoBehaviour
{
    ...
    private void PrepareTermsAndDefinitions()
    {
        ...
        termsDefinitions.Add("Distribution Statement B", "Distribution authorized to U.S. government agencies only");
        termsDefinitions.Add("Destroying unclassified documents", "Shredding or burning");
        termsDefinitions.Add("A type of STINFO", "Technical Order");
    ...
    private void LoadNextScene()
    {
        ...
        // For example:
        SceneManager.LoadScene("DictionaryScene4");
    }
